...
-- Description: Create queue_items table for the web UI queue page.
--   The table schema was defined in src/db/queue.rs::create_queue_tables()
--   but was never included in the migration sequence. The queue handler
--   in web_ui.rs queries this table, causing "no such table" errors.
-- Created: 2026-02-07
